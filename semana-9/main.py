...
def plot(x, y, num_img=1):
    ...
    plt.tight_layout()
    plt.savefig(f"semana-9/interpolacao_{num_img}.png", dpi=120, bbox_inches="tight")
    plt.close()
...
def main():
    ...
    y = np.array(
        [80.0,-60.0,40.0,-30.0,20.0,-10.0,5.0,-2.5,1.25,-0.625,0.3125,],
        dtype=float,
    )
